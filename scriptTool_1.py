...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        self.creation_script.setGeometry(QtCore.QRect(20, 40, 75, 23))
        ...
        self.creation_script.setStyleSheet("QPushButton:hover:!pressed\n"
                                           "{\n"
                                           "  border: 1px solid lime;\n"
                                           "background-color: rgb(0, 0, 0);\n"
                                           "font: 10 10pt \"Cambria\";\n"
                                           "color: rgb(255, 255, 255);\n"
                                           "}\n"
                                           "\n"
                                           "QPushButton\n"
        ...
        self.creation_edit.setGeometry(QtCore.QRect(110, 40, 271, 21))
                ...
                with open(self.creation_edit.text(), 'r') as f:
                    ...
                    for i in queries:
                        ...
                        try:
                            ...
                            my_fnc.createDirectory(os.path.join(dir_path, self.select_server_val))
                            errors+=str(err)+'\n'
                            nb_query_failed += 1
                    ...
                    if creation_errors:
                        ...
                        with open(
                                os.path.expandvars(
                                    os.path.join(dir_path, self.select_server_val)) + r'\Log_' + timestump + '.log',
                                'w') as log_file:
